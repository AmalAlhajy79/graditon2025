...
import '../../../data/data_source/verefication-hall-admin-data-source.dart';

class vereficationHallAdminController extends GetxController {
  ...
  void ChangePassword() async {
    ...
    _dataState = await handle<void>(
            () =>
                vereficationHallAdminDataSource.vereficationAdminHall(
