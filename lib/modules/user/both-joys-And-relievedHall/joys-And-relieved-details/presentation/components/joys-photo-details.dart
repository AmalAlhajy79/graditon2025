...
//نهائي قسم الافراح
class BothJoysPhotoScreen extends GetView<BothDetailsJoysReHallController> {
  static const name = '/BothJoysPhotoScreen';
  static final page = GetPage(
      name: name,
      page: () => BothJoysPhotoScreen(),
              ...
              child: ListView(
                children: [
                  ...
                  GridView.builder(
                    ...
                    itemCount: controller.joysImages.length,//6,
                    itemBuilder: (context, index) {
                      final image = controller.joysImages[index];
                      if (index == 0) {
                        // عرض أول صورة بمفردها
                        return Padding(
                          padding: EdgeInsets.only(right: 1.w, left: 1.w),
                          child: Container(
                            decoration: BoxDecoration(
                              image: DecorationImage(
                                image: NetworkImage(ApiConst.urlImage +'${image.imagePath}'),//AssetImage('assets/images/hall1.jpg'), // استبدل بالصورة المناسبة
                                fit: BoxFit.cover,
                              ),
                            ),
                          ),
                        ...
                        // عرض باقي الصور كل صورة لوحدها
                        return Padding(
                          padding: EdgeInsets.only(right: 1.w, left: 1.w),
                          child: Container(
                            decoration: BoxDecoration(
                              image: DecorationImage(
                                image: NetworkImage(ApiConst.urlImage +'${image.imagePath}'), //AssetImage('assets/images/hall1.jpg'), // استبدل بالصور المناسبة
                                fit: BoxFit.cover,
                              ),
                            ),
                          ),
