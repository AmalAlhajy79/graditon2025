...
class DecorJoysServicesScreen extends GetView<BothJoysReHallController> {
  static const name = '/DecorJoysServicesScreen';
  static final page = GetPage(
      name: name,
      page: () => DecorJoysServicesScreen(),
                  ...
                  child: Column(
                    children: [
                      Container(
                          ...
                          children: [
                            ...
                            GridView.builder(
                              ...
                              itemCount: controller.joysServices
                                  .where((service) => service.name.toLowerCase().contains('decoration'))
                        ...
                        //                   image: DecorationImage(
                        //                     image:
                        //                     AssetImage('assets/images/decor1.png'),
